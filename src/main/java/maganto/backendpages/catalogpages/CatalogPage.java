...
public class CatalogPage {
    ...
    @FindBy(xpath = "//span[text()='The search was deleted.']")
    ...
    public void EditSearchTerm() {
        ...
        utility.sleep(2);
        utility.javaScriptClick(editIcon);
        utility.sleep(2);
        utility.waitForElementPresent(searchQueryField);
    ...
    public boolean verifyDeleteSearchTerm() {
        utility.waitForElementPresent(deletedMessage);
